...
export const carouselData = [
    {
        ...
        description: '13,000-12,000 Years Old, Gault Site, Bell County, TX',
        text: 'Archeologists think that Clovis points, like this one, were attached to foreshafts for use as both spear points and knives. Under the microscope they can see tiny grooves on the surface of the stone where it was attached.',
    },
    {
        id: 'carouseltwo',
        image: carousel2,
    ...
    },
    {
        ...
        image: carousel6,
        title: 'Modified Flake',
        description: '~13,000 Years Old, Gault Site, Bell County, TX',
