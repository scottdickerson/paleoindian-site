import carousel1 from '@/data/daily-life/Images/3-6-1 Pojectile Point.webp'
import carousel2 from '@/data/daily-life/Images/3-6-2 Obsidian.webp'
import carousel3 from '@/data/daily-life/Images/3-6-3 Blade.webp'
import carousel4 from '@/data/daily-life/Images/3-6-4 Starch Grain Analysis.webp'
import carousel5 from '@/data/daily-life/Images/3-6-5 Starch Analysis.webp'
import carousel6 from '@/data/daily-life/Images/3-6-6 Modified Flake.webp'
import carousel7 from '@/data/daily-life/Images/3-6-7 Blade.webp'
import carousel8 from '@/data/daily-life/Images/3-6-8 Adze.webp'
...
export const carouselData = [
    ...
    },
    {
        ...
        description: '13,000-12000 BP, Kincaid Site, Uvalde County, TX',
        text: 'Archeologist used stone sourcing to learn that this tool is made of a type of obsidian which comes from Querétaro, Mexico—more than 600 miles to the south of where it was found. Stone sourcing helps us learn about ancient people’s travel and trade.',
    },
    {
        id: 'carouselthree',
        image: carousel3,
    ...
    },
    {
        ...
        description: '13,000 – 12,000 BP, Gault Site, Bell County, TX',
        text: 'Scientists discovered microscopic starch grains still clinging to this modified flake. Around 13,000 years ago, someone used this tool to harvest plants similar to wildrye or barley.',
    },
    {
        id: 'carouselfive',
        image: carousel5,
