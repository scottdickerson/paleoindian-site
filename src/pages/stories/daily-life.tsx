...
const DAILY_LIFE_TEXAS_SECTIONS: StorySectionProps[] = [
    {
        ...
        description:
            "<p>16,000 years ago, everybody, everywhere lived as hunter-gatherers. But that doesn't mean people were simple! They had deep knowledge and skills to thrive in their enviroments.</p><p>Flip through the cards below and put yourself in their woven grass sandals!</p>",
        interactive: (
        ...
        details: (
            <>
            <p>
               When Paleoindians first walked into Texas, they shared a lifestyle with every other person on the planet. It would be thousands of years before humanity got around to inventing agriculture, forging metal, or even making pottery.
            </p>
            <p>
    ...
    },
    {
        ...
        details: (
            <>
            <p>
                Until recently, illustrations of Paleoindaian life almost always featured guys with stone spears...and not much else. We need to remember that the earliest peoples made things that are far rarer than stone in the archeological record. Woven mats and sandals, bone tools, and ceremonial items have been found in Texas sites, usually in caves where cool, dry air helps preserve these precious clues to the lives of Paleoindians.
            </p>
            </>
        ),
    },
    {
        ...
        description:
            "<p>Paleoindians did hunt mammoths and other mega-fauna, but not <strong>every</strong> day. Would you like to bust your hump hunting a dangerous animal or would you just kick back and catch a fish?</p><p>Check out what was on the menu.</p>",
        interactive: (
            <Cards cards={cardData} pdf="/pdfs/Ice Age Texas Cards.pdf" />
        ),
        details: (
            <>
            <p>
                It's fun to think about the skills and talent needed to take home a mammoth for dinner, but archeologists now know that people ate a lot of other things that were way easier to manage. How do we know what Paleoindians ate for dinner? Many different fields of study can help answer that question. Paleoethnobotanists study charred seeds from campfires. Lithic analysts study tiny residue of animal blood and plant starches left on tools.
            </p>
            <p>
    ...
    },
    {
        ...
        details: (
            <>
            <p>
                Native American ancestors became experts in selecting native plants for food and medicine. They knew the best season and location for harvesting specific plants or hunting their favorite game. They learned where to find the right kind of stone for tool making. And they learned to navigate from place to place, finding the best places to cross a river or mountain. They passed this kowledge and deep relationship with the landscape down through the generations, where it still flows today.
            </p>
            </>
        ),
    },
    {
        ...
        details: (
            <>
            <p>
                When Paleoindians first came to the Americas, domesticated dogs were trotting along besides them. Bones and other artifacts discovered around ancient camp sites tell us a lot about man's best friend. By studying DNA, we know that dogs and people were together long before they came to North America. In fact, Native Americans' dogs were descended from a line of grey wolves in Eurasia. Scientists can trace their DNA back through generations to learn more about how dogs - and their friendships with people - changed over time.
            </p>
            </>
        ),
    },
    {
        ...
        id: 'written-in-stone',
        summary: 'Stone tells a story if you ask the right questions.',
        description:
            "<p>When archeologists find stone tools, even broken pieces, they open a window in to the past. They carefully document the artifact's position and context and then study it in the lab.</p> <p>Scroll through these Paleoindian artifacts.</p>",
        interactive: (
            <DailyLifeCarousel
                images={carouselData}
            />
