...
const DAILY_LIFE_TEXAS_SECTIONS: StorySectionProps[] = [
    {
        ...
        details: (
            <>
                <p>
                    When Paleoindians first walked into Texas, they shared a
                    lifestyle with every other person on the planet. It would be
                    thousands and thousands of years before humanity would get
                    around to inventing agriculture, forging metal, or even
                    making pottery.
                </p>
                <p>
                    Being a
                    ...
                    />
                    meant having a deep understanding of the land, the animals,
                ...
                <p>
                    ...
                    important to remember that ancient peoples played games,
                    told stories, made music, and lived full lives with their
                    friends and family.
                </p>
            </>
        ),
    },
    {
        ...
        description: `<p>But do their powers of preservation paint an uneven picture of Paleoindian peoples? </p>
    ...
    },
    {
        ...
        details: (
            <>
                <p>
                    It’s fun to think about the skills and talent needed to take
                    home a mammoth for dinner, but archeologists now know that
                    people ate a lot of other things that were way easier to
                    manage. How do we know what Paleoindians ate for dinner?
                    Many different fields of study can help answer that
                    question. Zooarcheologists study animal bones found in
                    archeological sites. Paleoethnobotanists study charred seeds
                    from campfires. Lithic analysts study tiny residue of animal
                    blood and plant starches left on tools.
                </p>
                <p>
                    We know that Paleoindians hunted and trapped lots of
                    different animals and ate plenty of plants. Although hunters
                    are often depicted as men, women and children did their fair
                    share of work to keep everybody fed. Animals like deer,
                    rabbits, turtles, and fish would have been a reliable source
                    of protein. Native Texas plants, like pecans, tubers, and
                    wild onions, provided nutrition and flavor.
                </p>
            </>
        ),
    },
        ...
        details: (
            <>
                <p>
                    ...
                    harvesting specific plants or hunting their favorite game.
                    They learned where to find the right kind of stone for tool
        ...
        details: (
            <>
                <p>
                    ...
                    />
                    dogs were trotting along beside them. Bones and other
                    artifacts discovered around ancient camp sites tell us a lot
                    about man’s best friend. By studying DNA, we know that dogs
                    and people were together long before they came to North
                    America. In fact, Native Americans’ dogs were
                    <Tooltip
                        trigger="descended"
                        content={TOOLTIP_CONTENT.descended}
                    />
                    from a line of grey wolves in Eurasia. Scientists can trace
                    their DNA back through generations to learn more about how
                    dogs – and their friendships with people – changed over
                    time.
                </p>
            </>
        ),
        ...
        details: (
            <>
                <p>
                    ...
                    information is lost. Additionally, they may disturb a grave
                    or other sacred spot. It’s very important to never dig or
                    disturb a place where ancient Indigenous people lived.
                </p>
            </>
        ),
    },
