...
import vocabExample from '@/data/educator-guide/VocabExample.gif'
import tocExample from '@/data/educator-guide/Site Breakdown/SiteBreakdown_2x.webp'
...
import interpretImage from '@/data/educator-guide/Magnifying Glass/MagnifyingGass_2x.webp'
